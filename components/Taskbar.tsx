...
const Taskbar: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-[400px] sm:w-auto sm:max-w-none">
      <div className="flex items-center justify-between sm:justify-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 bg-[#151A23]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.5)] transition-all hover:bg-[#151A23]/90 hover:border-white/20">
