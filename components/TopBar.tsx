...
const TopBar: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-8 bg-[#0B0E14] border-b border-white/5 z-50 flex items-center justify-between px-3 sm:px-4 font-mono text-xs select-none">
      {/* Left: Workspaces */}
      ...
      <div className="flex items-center gap-3 sm:gap-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3 pl-0 sm:pl-3 sm:border-l border-white/10">
           ...
           <Volume2 size={12} className="text-gray-400 hidden sm:block" />
           <Battery size={12} className="text-primary" />
        </div>

        {/* Clock */}
        <div className="flex items-center gap-2 bg-surfaceHighlight px-2 sm:px-3 py-0.5 sm:py-1 rounded text-gray-300 ml-1 sm:ml-2">
