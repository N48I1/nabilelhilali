                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-surfaceHighlight border border-white/5 p-8 rounded-2xl shadow-2xl">
                                ...
                                <a
                                    ...
                                    className="w-full mt-6 flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white py-3 rounded-lg transition-colors border border-white/5"
                                >
